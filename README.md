...
This is the frontend API of the project. The backend API (which is required) for this application can be found [here](https://github.com/tantigers/triptime-api).
